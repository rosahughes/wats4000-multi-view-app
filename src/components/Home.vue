<template>
  <div class="home">
    <div v-show="showForm" class="form-container">
      ...
      <p v-show="showError" class="error">There are errors in the form data you have submitted. Please check your information. All fields are required.</p>
      ...
      <form v-on:submit.prevent="validateForm">
        ...
        <p><label for="password">
          <input type="password" id= "password" v-model="password" placeholder="Enter password here">
        </label></p>

        <p><label for="passwordVerify">
          <input type="password" id= "passwordVerify" v-model="passwordVerify" placeholder="Verify password">
        </label></p>
